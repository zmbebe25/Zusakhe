...
output_json_path = "C:/Users/Zusakhe Mbebe/course-data/Zusakhe/Auto-requirements/Page67.json"

# Open the PDF file
with pdfplumber.open(pdf_path) as pdf:
    page = pdf.pages[66]  # Note: Python is 0-indexed, so page 32 is accessed by index 31
