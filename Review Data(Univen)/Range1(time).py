...
output_file = "C:/Users/zusakhe_gradesmatch/Downloads/merged_dataTimeReviewFinalSummary(2023).json"
...
for institution in data:
    for user in institution.get("Users", []):
        ...
        # Filter out review times less than 1 minute
...
# Find the slowest and fastest review times
...
with open(output_file, "w") as output_file:
    json.dump({"PerformanceCategories": performance_categories, "ReviewSummary": summary}, output_file, indent=4)

print(f"Processed data with slowest and fastest reviews has been saved to {output_file}")
